...
Route::get('/login/{lang?}', [AuthenticatedSessionController::class,'showLoginForm'])->name('login')->middleware('allow-embed');
...
Route::group(
    [
        ...
        Route::resource('contractType', ContractTypeController::class)->middleware(['auth','XSS'])->middleware('allow-embed');
...
Route::get('retainer/{id}/payment', [RetainerController::class,'payment'])->name('retainer.payment')->middleware('allow-embed');
...
Route::post('email_template_status/{id}', [EmailTemplateController::class,'updateStatus'])->name('status.email.language')->middleware(['auth','XSS']);
...
Route::prefix('customer')->as('customer.')->group(
    function (){
        Route::get('login/{lang}', [AuthenticatedSessionController::class,'showCustomerLoginLang'])->name('login.lang')->middleware(['XSS'])->middleware('allow-embed');
        Route::get('login', [AuthenticatedSessionController::class,'showCustomerLoginForm'])->name('login')->middleware(['XSS'])->middleware('allow-embed');
        Route::post('login', [AuthenticatedSessionController::class,'customerLogin'])->name('login')->middleware(['XSS'])->middleware('allow-embed');
        ...
        Route::get('invoice', [InvoiceController::class,'customerInvoice'])->name('invoice')->middleware(['auth:customer','XSS'])->middleware('allow-embed')->middleware('token.auth');
        Route::get('/invoice/pay/{invoice}', [InvoiceController::class,'payinvoice'])->name('pay.invoice')->middleware(['auth:customer','XSS']);
        Route::get('/retainer/pay/{retainer}', [RetainerController::class,'payretainer'])->name('pay.retainerpay')->middleware(['auth:customer','XSS']);
...
Route::prefix('vender')->as('vender.')->group(
    function (){
        ...
        Route::get('login/{lang}', [AuthenticatedSessionController::class,'showVenderLoginLang'])->name('login.lang')->middleware(['XSS'])->middleware('allow-embed');
        Route::get('login', [AuthenticatedSessionController::class,'showVenderLoginForm'])->name('login')->middleware(['XSS'])->middleware('allow-embed');
        Route::post('login', [AuthenticatedSessionController::class,'VenderLogin'])->name('login')->middleware(['XSS'])->middleware('allow-embed');
        ...
        Route::get('bill', [BillController::class,'VenderBill'])->name('bill')->middleware(['auth:vender','XSS','revalidate'])->middleware('allow-embed');
...
Route::get('/', [DashboardController::class,'index'])->name('dashboard')->middleware(['XSS','revalidate'])->middleware('allow-embed');
...
Route::group(
    ...
    Route::resource('bank-account', BankAccountController::class)->middleware('allow-embed');
...
Route::group(
    ...
    Route::resource('transfer', TaxController::class);
...
Route::resource('product-category', ProductServiceCategoryController::class)->middleware(['auth','XSS','revalidate'])->middleware('allow-embed');

Route::resource('taxes', TaxController::class)->middleware(['auth','XSS','revalidate'])->middleware('allow-embed');

Route::resource('product-unit', ProductServiceUnitController::class)->middleware(['auth','XSS','revalidate'])->middleware('allow-embed');
...
Route::resource('revenue', RevenueController::class)->middleware(['auth','XSS','revalidate'])->middleware('allow-embed');
...
Route::group(
    [
        ...
        Route::get('report/transaction', [TransactionController::class,'index'])->name('transaction.index')->middleware('allow-embed');
...
Route::group(
    [
        ...
        Route::get('report/income-summary', [ReportController::class,'incomeSummary'])->name('report.income.summary')->middleware('allow-embed');
        Route::get('report/expense-summary', [ReportController::class,'expenseSummary'])->name('report.expense.summary')->middleware('allow-embed');
        Route::get('report/income-vs-expense-summary', [ReportController::class,'incomeVsExpenseSummary'])->name('report.income.vs.expense.summary')->middleware('allow-embed');

    
    Route::get('report/tax-summary', [ReportController::class,'taxSummary'])->name('report.tax.summary')->middleware('allow-embed');
    Route::get('report/profit-loss-summary', [ReportController::class,'profitLossSummary'])->name('report.profit.loss.summary')->middleware('allow-embed');
    Route::get('report/invoice-summary', [ReportController::class,'invoiceSummary'])->name('report.invoice.summary')->middleware('allow-embed');
    

    Route::get('report/bill-summary', [ReportController::class,'billSummary'])->name('report.bill.summary')->middleware('allow-embed');
    ...
    Route::get('report/balance-sheet', [ReportController::class,'balanceSheet'])->name('report.balance.sheet')->middleware('allow-embed');
    Route::get('report/ledger', [ReportController::class,'ledgerSummary'])->name('report.ledger')->middleware('allow-embed');
    Route::get('report/trial-balance', [ReportController::class,'trialBalanceSummary'])->name('trial.balance')->middleware('allow-embed');
...
Route::resource('account-assets', AssetController::class)->middleware(['auth','XSS','revalidate'])->middleware('allow-embed');
Route::resource('custom-field', CustomFieldController::class)->middleware(['auth','XSS','revalidate'])->middleware('allow-embed');
...
///// saya yang bikin bil
Route::resource('chart-of-account-type', ChartOfAccountTypeController::class)->middleware('allow-embed');
...
Route::group(
    ...
    Route::resource('chart-of-account', ChartOfAccountController::class)->middleware('allow-embed');
...
Route::group(
    ...
    Route::resource('journal-entry', JournalEntryController::class)->middleware('allow-embed');
...
// Route::get('/proposal/pay/{proposal}', [InvoiceController::class,'proposalpay'])->name('pay.proposalpay');
Route::get('/proposal/pay/{proposal}', [ProposalController::class,'payproposal'])->name('pay.proposalpay');
Route::resource('InvoiceUniquip', InvoiceUniquipController::class)->middleware(['auth','XSS','revalidate'])->middleware('allow-embed');
...
//Route::get('export/vender', [VenderController::class,'export'])->name('vender.export');
Route::get('import/COA/file', [ChartOfAccountController::class,'importFile'])->name('COA.file.import');
Route::post('import/COA', [ChartOfAccountController::class,'import'])->name('COA.import');
