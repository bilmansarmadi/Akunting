            ...
            <div class="form-group">
                <?php if(!empty($permissions)): ?>
                    ...
                    <table class="table  mb-0" id="dataTable-1">
                        ...
                        <tbody>
                        <?php
                            $modules=['dashboard','user','role','proposal','invoice','invoice uniquip','bill','revenue','payment','proposal product','invoice product','bill product','goal','bank account','transfer','transaction','product & service','customer','vender','plan','constant tax','constant category','constant unit','constant custom field','constant coa','company settings','assets','chart of account','journal entry','report'];
                                    ...
                                    <div class="row">
                                        ...
                                        <?php if(in_array('income vs expense '.$module,(array) $permissions)): ?>
                                            <?php if($key = array_search('income vs expense '.$module,$permissions)): ?>
                                                <div class="col-md-3 custom-control custom-checkbox">
                                                    <?php echo e(Form::checkbox('permissions[]',$key,$role->permission, ['class'=>'form-check-input','id' =>'permission'.$key])); ?>
...
<?php /**PATH /home/u145602709/domains/lubirastudios.com/public_html/Project001/resources/views/role/edit.blade.php ENDPATH**/ ?>