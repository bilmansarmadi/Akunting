            ...
            <div class="form-group">
                <?php if(!empty($permissions)): ?>
                    ...
                    <table class="table  mb-0" id="dataTable-1">
                        ...
                        <tbody>
                        <?php
                            $modules=['dashboard','user','role','proposal','invoice','invoice uniquip','bill','revenue','payment','proposal product','invoice product','bill product','goal','credit note','debit note','bank account','transfer','transaction','product & service','customer','vender','plan','constant tax','constant category','constant unit','constant custom field','constant coa','company settings','assets','chart of account','journal entry','report'];
...
<?php /**PATH /home/u145602709/domains/lubirastudios.com/public_html/Project001/resources/views/role/create.blade.php ENDPATH**/ ?>