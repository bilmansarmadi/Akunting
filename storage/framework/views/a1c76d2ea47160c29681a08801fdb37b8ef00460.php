...
unset($__errorArgs, $__bag); ?>" name="current_password" type="password" id="current_password" required autocomplete="current_password" >
...
unset($__errorArgs, $__bag); ?>" name="new_password" type="password" required autocomplete="new-password" id="new_password" >
...
unset($__errorArgs, $__bag); ?>" name="confirm_password" type="password" required autocomplete="new-password" id="confirm_password" >
                            </div>
                            <div class="col-lg-12 text-end">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/lubirastudios.com/public_html/Project001/resources/views/user/profile.blade.php ENDPATH**/ ?>