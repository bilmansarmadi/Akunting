...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col">
                                <div class="row">
                                    ...
                                    <div class="col-4 my-auto">
                                        <div class="form-group">
                                            <label class="text-dark mb-1 mt-3" for="gdpr_cookie"><?php echo e(__('GDPR Notification')); ?></label>
                                            <div class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 my-auto">
                                <div class="form-group ">
                                    <div class="">
                                    <?php echo e(Form::label('cookie_text',__('GDPR Cookie Text'),array('class'=>'gdpr_cookie_text form-label') )); ?>

                                    <?php echo Form::textarea('cookie_text',isset($settings['cookie_text']) && $settings['cookie_text'] ? $settings['cookie_text'] : '' , ['class'=>'form-control gdpr_cookie_text','style'=>'display: hidden;resize: none;','rows'=>'4']); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/lubirastudios.com/public_html/Project001/resources/views/settings/company.blade.php ENDPATH**/ ?>