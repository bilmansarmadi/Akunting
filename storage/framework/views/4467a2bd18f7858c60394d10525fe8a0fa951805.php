...
<?php $__env->startSection('auth-lang'); ?>
    <select class="btn btn-primary my-1 me-2 " onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);" id="language">
        <?php $__currentLoopData = Utility::languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option <?php if($lang == $language): ?> selected <?php endif; ?> value="<?php echo e(route('vender.change.langPass',$language)); ?>"><?php echo e(Str::upper($language)); ?></option>
...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('vender.password.email')); ?>">
        <?php echo csrf_field(); ?>
        <div class="">
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="my-4 text-center"><?php echo e(__('Back to')); ?> <a href="<?php echo e(route('vender.login')); ?>" class="text-primary"><?php echo e(__('Login')); ?></a></p>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/lubirastudios.com/public_html/Project001/resources/views/auth/vendorEmail.blade.php ENDPATH**/ ?>