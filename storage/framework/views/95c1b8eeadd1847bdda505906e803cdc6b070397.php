...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create chart of account')): ?>
                <a href="#" class="btn btn-sm btn-primary" data-url="<?php echo e(route('COA.file.import')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip"
                                        ...
                                        <td class="Action">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit chart of account')): ?>
                                                <div class="action-btn bg-info ms-2">
                                                    <a class="mx-3 btn btn-sm align-items-center" data-url="<?php echo e(route('chart-of-account.edit',$account->id)); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Edit Account')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-original-title="<?php echo e(__('Edit')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/lubirastudios.com/public_html/Project001/resources/views/chartOfAccount/index.blade.php ENDPATH**/ ?>