                        ...
                        <table class="table  mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%" class="form-group pt-0">
                                    <?php echo e(Form::select('item', $product_services,'', array('class' => 'form-control item','data-url'=>route('invoice.product'),'required'=>'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u145602709/domains/lubirastudios.com/public_html/Project001/resources/views/invoice/create.blade.php ENDPATH**/ ?>