            ...
            <div class="form-group">
                <?php if(!empty($permissions)): ?>
                    ...
                    <table class="table  mb-0" id="dataTable-1">
                        ...
                        <tbody>
                        <?php
                            $modules=['dashboard','user','role','proposal','invoice','bill','revenue','payment','proposal product','invoice product','bill product','goal','bank account','transfer','transaction','product & service','customer','vender','plan','constant tax','constant category','constant unit','constant custom field','constant coa','company settings','assets','chart of account','journal entry','report'];
...
<?php /**PATH /home/u145602709/domains/hanfellas.com/public_html/PROJECT001/resources/views/role/edit.blade.php ENDPATH**/ ?>