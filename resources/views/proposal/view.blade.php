...
@else
    @if($proposal->converted_invoice_id==0)
        @can('convert invoice')
            <div class="action-btn bg-success ms-2">
                <a href="{{ route('retainer.show',\Crypt::encrypt($proposal->converted_retainer_id)) }}" class="btn btn-sm btn-primary align-items-center" data-bs-toggle="tooltip" title="{{__('Already convert to Retainer')}}" >
...
@else
    @can('show invoice')
        <div class="action-btn bg-warning ms-2">
            <a href="{{ route('invoice.show',\Crypt::encrypt($proposal->converted_invoice_id)) }}" class="btn btn-sm btn-warning align-items-center" data-bs-toggle="tooltip" title="{{__('Already convert to Invoice')}}" >
                <i class="ti ti-eye text-white"></i>
            </a>
        </div>
    @endcan
