                ...
                if (res.flag == 1) {
                    ...
                    var handler = PaystackPop.setup({
                        ...
                        callback: function (response) {
                            ...
                            window.location.href = '{{ url("customer/invoice/paystack") }}'+'/'+'{{ \Illuminate\Support\Facades\Crypt::encrypt($invoice->id) }}'+'/'+amount+ '/' + response.reference;
                    ...
                    var x = getpaidSetup({
                        ...
                        callback: function (response) {
                            ...
                            if (
                                ...
                                window.location.href = '{{ url("customer/invoice/flaterwave") }}'+'/'+'{{ \Illuminate\Support\Facades\Crypt::encrypt($invoice->id) }}'+'/'+txref;
                            } else {
                ...
                if (res.flag == 1) {
                    ...
                    var options = {
                        ...
                        "handler": function (response) {
                            window.location.href = '{{ url("customer/invoice/razorpay") }}'+'/'+'{{ \Illuminate\Support\Facades\Crypt::encrypt($invoice->id) }}'+'/'+amount;
