                    ...
                    <div class="row">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col">
                                <div class="row">
                                    ...
                                    <div class="col-4 my-auto">
                                        <div class="form-group">
                                            <label class="text-dark mb-1 mt-3" for="gdpr_cookie">{{ __('GDPR Notification') }}</label>
                                            <div class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 my-auto">
                                <div class="form-group ">
                                    <div class="">
                                    {{Form::label('cookie_text',__('GDPR Cookie Text'),array('class'=>'gdpr_cookie_text form-label') )}}
                                    {!! Form::textarea('cookie_text',isset($settings['cookie_text']) && $settings['cookie_text'] ? $settings['cookie_text'] : '' , ['class'=>'form-control gdpr_cookie_text','style'=>'display: hidden;resize: none;','rows'=>'4']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
