...
<div class="proposal-preview-main" id="boxes">
    <div class="proposal-header">
        <table class="vertical-align-top">
            ...
            <tr>
                <td >
                    <h3 style=" display: inline-block; text-transform: uppercase; font-size: 40px; font-weight: bold; border-top: 5px solid var(--theme-color); padding-top: 5px;">{{__('RETAINER')}}</h3>
                ...
                <td>
                    <table class="no-space">
                        ...
                        <tr>
                            ...
                            <td class="text-right">{{Utility::retainerNumberFormat($settings,$retainer->retainer_id)}}</td>
                        </tr>
                        <tr>
                            <td style="color: var(--theme-color);"><b>{{__('Issue Date:')}}</b></td>
                            <td class="text-right">{{Utility::dateFormat($settings,$retainer->issue_date)}}</td>
                        </tr>
            ...
            <tr>
                ...
                <td colspan="2" class="sub-total">
                    <table class="total-table">
                        ...
                        <tr>
                            <td>{{__('Total')}}:</td>
                            <td>{{Utility::priceFormat($settings,$retainer->getSubTotal()-$retainer->getTotalDiscount()+$retainer->getTotalTax())}}</td>
                        </tr>
