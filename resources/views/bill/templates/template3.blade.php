            ...
            <tr>
                ...
                <td>
                    <table class="no-space">
                        <tbody>
                        <tr>
                            <td class="text-right" style="padding-left: 346px;">{{__('Number')}}:</td>
                            <td class="text-right">{{Utility::billNumberFormat($settings,$bill->bill_id)}}</td>
                        </tr>
                        <tr>
                            <td class="text-right" style="padding-left: 346px;">{{__('Issue Date')}}:</td>
                            <td class="text-right">{{Utility::dateFormat($settings,$bill->issue_date)}}</td>
                        </tr>

                        <tr>
                            <td class="text-right" style="padding-left: 346px;">{{__('Due Date')}}:</td>
                            <td class="text-right">{{Utility::dateFormat($settings,$bill->issue_date)}}</td>
                        </tr>
