...
@section('action-btn')
    <div class="float-end">
        @can('create chart of account')
                <a href="#" class="btn btn-sm btn-primary" data-url="{{ route('COA.file.import') }}" data-ajax-popup="true" data-bs-toggle="tooltip"
                title="{{ __('Import') }}">
                                        ...
                                        <td class="Action">
                                            ...
                                            @can('edit chart of account')
                                                <div class="action-btn bg-info ms-2">
                                                    <a class="mx-3 btn btn-sm align-items-center" data-url="{{ route('chart-of-account.edit',$account->id) }}" data-ajax-popup="true" data-title="{{__('Edit Account')}}" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
