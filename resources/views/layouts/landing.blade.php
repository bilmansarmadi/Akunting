...
<body class="{{$color}}" dir="{{$SITE_RTL == 'on'?'rtl':''}}">
<!-- [ Nav ] start -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 text-end">
                <p class="text-body">{{(\App\Models\Utility::getValByName('footer_text')) ? \App\Models\Utility::getValByName('footer_text') :  __('Copyright AccountGo') }} {{ date('Y') }}</p>
            </div>
        </div>
    </div>
</section>
